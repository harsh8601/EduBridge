      ...
      <div className='max-w-6xl mx-auto bg-white shadow-md rounded-xl p-6 space-y-6 relative'>
        ...
        <div className='flex flex-col md:flex-row gap-6'>
          ...
          <div className='w-full md:w-1/2'>
            <FaArrowLeftLong className='text-[black] w-[22px] cursor-pointer' onClick={()=>navigate("/")}/>
          ...
          <div className='flex-1 space-y-2 mt-[20px]'>
            ...
            <div className='flex items-start flex-col justify-between'>
              ...
              {!isEnrolled ? <button className='bg-[black] text-white px-6 py-2 rounded hover:bg-gray-700 mt-8 cursor-pointer' onClick={()=>handleEnroll(userData._id,courseId)}>Enroll Now</button> :<button className='bg-green-100 text-green-500 px-6 py-2 rounded hover:bg-gray-700 mt-8 cursor-pointer' onClick={()=>navigate(`/viewlecture/${courseId}`)}>Watch Now</button> }
            </div>
          </div>
        </div>
        ...
        <div className='flex flex-col md:flex-row gap-6'>
          <div className='bg-white w-full md:w-2/5 p-6 rounded-2xl shadow-lg border border-gray-200'>
            <h2 className='text-xl font-bold mb-1 text-gray-800'>Course Curriculam</h2>
