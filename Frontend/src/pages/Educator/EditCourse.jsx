  ...
  return (
    <div className='max-w-5xl mx-auto p-6 mt-10 bg-white rounded-lg shadow-md'>
        ...
        <div className='flex items-center justify-center gap-[20px] md:justify-between flex-col md:flex-row mb-6 relative'>
                <FaArrowLeftLong className='absolute top-[-20%] left-[0] md:top-[20%] md:left-[2%] w-[22px] h-[22px] cursor-pointer' onClick={()=>navigate("/courses")}/>
            ...
            <form className='space-y-6' onSubmit={(e)=>e.preventDefault()}>
                ...
                <div className='flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0'>
                    ...
                    <div className='flex-1'>
                        ...
                        <input id='price' type="number" name='' className='w-full border px-4 py-2 rounded-md' placeholder='₹'  onChange={(e)=>setPrice(e.target.value)} value={price}/>
                    </div>
                </div>

                <div>
                    <label htmlFor="" className='bloack text-sm font-medium text-gray-700 mb-1'>Course Thumbnail</label>
